...
HijriDate.prototype.getDateFormated = function () {
    return (this.getMonth() + 1) + '/' + this.getDate() + '/' + this.getFullYear();
};
...
Datepicker.language['ar']={
	...
	monthNames:["يناير","فبراير","مارِس","أبريل","مايو","يونيو","يوليو","اغسطس","سبتمبر","اكتوبر","نوفمبر","ديسمبر"],
	weekdayNames:["الاحد","الإثنين","الثلاثاء","الأربعاء","الخميس","الجمعة","السبت"],
	hMonthNames:["المحرم","صفر ","ربيع الاول","ربيع الاخر","جمادي الأولى","جمادي الاخر","رجب","شعبان","رمضان","شوال","ذو القعدة","ذو الحجة"]
};
