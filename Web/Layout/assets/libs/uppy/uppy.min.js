! function (e) {
        ...
        ! function (e, t) {
            ...
            function F(e, t, n) {
                t.constructor === e.constructor && n === w && t.constructor.resolve === S ? function (e, t) {
                    t._state === $ ? B(e, t._result) : t._state === k ? U(e, t._result) : R(t, void 0, function (t) {
                        return O(e, t)
                    }, function (t) {
                        return U(e, t)
                    })
                }(e, t) : n === T ? (U(e, T.error), T.error = null) : void 0 === n ? B(e, t) : r(n) ? function (e, t, r) {
                    a(function (e) {
                        var n = !1,
                            o = function (r, o, i, s) {
                                try {
            ...
            function O(e, t) {
                var r, n;
                e === t ? U(e, new TypeError("You cannot resolve a promise with itself")) : (n = typeof (r = t), null === r || "object" !== n && "function" !== n ? B(e, t) : F(e, t, A(t)))
            }
            ...
            function U(e, t) {
                e._state === E && (e._state = k, e._result = t, a(x, e))
            }

            function R(e, t, r, n) {
                var o = e._subscribers,
                    i = o.length;
                e._onerror = null, o[i] = t, o[i + $] = r, o[i + k] = n, 0 === i && e._state && a(D, e)
            }
            ...
            function I(e, t, n, o) {
                ...
                if (i) {
                    ...
                    }(n, o)) === T ? (l = !0, a = s.error, s.error = null) : u = !0, t === s) return void U(t, new TypeError("A promises callback cannot return that same promise."))
                } else s = o, u = !0;
                t._state !== E || (i && u ? O(t, s) : l ? U(t, a) : e === $ ? B(t, s) : e === k && U(t, s))
            }
            var M = 0;

            function j(e) {
                e[P] = M++ , e._state = void 0, e._result = void 0, e._subscribers = []
            }
            var L = function () {
                function e(e, t) {
                ...
                return e.prototype._enumerate = function (e) {
                    ...
                    if (n === S) {
                        var o = A(e);
                        if (o === w && e._state !== E) this._settledAt(e._state, t, e._result);
                    ...
                    var n = this.promise;
                    n._state === E && (this._remaining-- , e === k ? U(n, r) : this._result[t] = r), 0 === this._remaining && B(n, this._result)
                }, e.prototype._willSettleAt = function (e, t) {
                    var r = this;
                    R(e, void 0, function (e) {
                        return r._settledAt($, t, e)
                    }, function (e) {
                        return r._settledAt(k, t, e)
                    })
                }, e
            }(),
                N = function () {
                    function e(t) {
                        this[P] = M++ , this._result = this._state = void 0, this._subscribers = [], C !== t && ("function" != typeof t && function () {
    ...
    var MultipartUploader = function () {
        ...
        _$Provider_91 = function (e) {
            function t(r, n) {
                ...
                return o.provider = n.provider, o.id = o.provider, o.authProvider = n.authProvider || o.provider, o.name = o.opts.name || _getName(o.id), o.pluginId = o.opts.pluginId, o.tokenKey = "companion-" + o.pluginId + "-auth-token", o
            }
            return function (e, t) {
                ...
                this.uppy.getPlugin(this.pluginId).storage.setItem(this.tokenKey, e)
                ...
                return this.get(this.id + "/logout?redirect=" + t).then(function (t) {
                    return e.uppy.getPlugin(e.pluginId).storage.removeItem(e.tokenKey), t
                })
                ...
                e.storage = e.opts.storage || localStorage
            }, ___createClass_91(t, [{
                key: "defaultHeaders",
                get: function () {
                    return ___extends_91({}, e.prototype.defaultHeaders, {
                        "uppy-auth-token": this.getAuthToken()
                    })
                }
            }]), t
        }(_$RequestClient_92),
    ...
    ! function () {
        ...
        function e(e, t) {
            ...
            for (t && null != t.children && (S.length || S.push(t.children), delete t.children); S.length;)
                ...
                else "boolean" == typeof n && (n = null), (o = "function" != typeof e) && (null == n ? n = "" : "number" == typeof n ? n = String(n) : "string" != typeof n && (o = !1)), o && r ? s[s.length - 1] += n : s === P ? s = [n] : s.push(n), r = o;
            var a = new v;
        ...
        function n(e) {
            !e.__d && (e.__d = !0) && 1 == $.push(e) && (w.debounceRendering || C)(o)
        }

        function o() {
            for (var e; e = $.pop();) e.__d && m(e)
        }
            ...
            if ("className" === t && (t = "class"), "key" === t);
                ...
                if ("style" === t) {
                    if (o && "string" != typeof o && "string" != typeof n || (e.style.cssText = o || ""), o && "object" == typeof o) {
                        ...
                        for (var s in o) e.style[s] = "number" == typeof o[s] && !1 === E.test(s) ? o[s] + "px" : o[s]
                    }
        ...
        function p() {
            for (var e; e = k.shift();) w.afterMount && w.afterMount(e), e.componentDidMount && e.componentDidMount()
        }

        function c(e, t, r, n, o, l) {
            T++ || (A = null != o && void 0 !== o.ownerSVGElement, F = null != e && !("__preactattr_" in e));
            var c = function e(t, r, n, o, l) {
                ...
                if (A = "svg" === m || "foreignObject" !== m && A, m = String(m), (!t || !i(t, m)) && (h = m, (_ = A ? document.createElementNS("http://www.w3.org/2000/svg", h) : document.createElement(h)).__n = h, p = _, t)) {
                ...
                if (null == v) {
                    v = p.__preactattr_ = {};
                    for (var S = p.attributes, P = S.length; P--;) v[S[P].name] = S[P].value
                }
                return !F && w && 1 === w.length && "string" == typeof w[0] && null != b && void 0 !== b.splitText && null == b.nextSibling ? b.nodeValue != w[0] && (b.nodeValue = w[0]) : (w && w.length || null != b) && function (t, r, n, o, s) {
                    ...
                    if (0 !== S)
                        for (var E = 0; E < S; E++) {
                            var $ = m[E],
                                k = $.__preactattr_,
                                T = C && k ? $._component ? $._component.__k : k.key : null;
                            null != T ? (v++ , b[T] = $) : (k || (void 0 !== $.splitText ? !s || $.nodeValue.trim() : s)) && (g[P++] = $)
                        }
                    if (0 !== C)
                        for (var E = 0; E < C; E++) {
                            c = r[E], h = null;
                            var T = c.key;
                            if (null != T) v && void 0 !== b[T] && (h = b[T], b[T] = void 0, v--);
                            else if (w < P)
                                for (u = w; u < P; u++)
                                    if (void 0 !== g[u] && (f = l = g[u], y = s, "string" == typeof (_ = c) || "number" == typeof _ ? void 0 !== f.splitText : "string" == typeof _.nodeName ? !f._componentConstructor && i(f, _.nodeName) : y || f._componentConstructor === _.nodeName)) {
                                        h = l, g[u] = void 0, u === P - 1 && P-- , u === w && w++;
                                        break
                                    } h = e(h, c, n, o), p = m[E], h && h !== t && h !== p && (null == p ? t.appendChild(h) : h === p.nextSibling ? a(p) : t.insertBefore(h, p))
                        }
                    if (v)
                        for (var E in b) void 0 !== b[E] && d(b[E], !1);
                    for (; w <= P;) void 0 !== (h = g[P--]) && d(h, !1)
                }(p, w, n, o, F || null != v.dangerouslySetInnerHTML),
                    function (e, t, r) {
                        var n;
                        for (n in r) t && null != t[n] || null == r[n] || u(e, n, r[n], r[n] = void 0, A);
                        for (n in t) "children" === n || "innerHTML" === n || n in r && t[n] === ("value" === n || "checked" === n ? e[n] : r[n]) || u(e, n, r[n], r[n] = t[n], A)
                    }(p, r.attributes, v), A = c, p
            }(e, t, r, n, l);
            return o && c.parentNode !== o && o.appendChild(c), --T || (F = !1, l || p()), c
        }
        ...
        function m(e, r, n, o) {
            if (!e.__x) {
                var i, a, u, l = e.props,
                    ...
                    A = !1,
                    F = S;
                if (e.constructor.getDerivedStateFromProps && (h = t(t({}, h), e.constructor.getDerivedStateFromProps(l, h)), e.state = h), P && (e.props = b, e.state = v, e.context = S, 2 !== r && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(l, h, _) ? A = !0 : e.componentWillUpdate && e.componentWillUpdate(l, h, _), e.props = l, e.state = h, e.context = _), e.__p = e.__s = e.__c = e.__b = null, e.__d = !1, !A) {
                    i = e.render(l, h, _), e.getChildContext && (_ = t(t({}, _), e.getChildContext())), P && e.getSnapshotBeforeUpdate && (F = e.getSnapshotBeforeUpdate(b, v));
                    var O, x, B = i && i.nodeName;
                    if ("function" == typeof B) {
                        var U = s(i);
                        (a = $) && a.constructor === B && U.key == a.__k ? y(a, U, 1, _, !1) : (O = a, e._component = a = f(B, U, _), a.__b = a.__b || C, a.__u = e, y(a, U, 0, _, !1), m(a, 1, n, !0)), x = a.base
                    } else u = E, (O = $) && (u = e._component = null), (E || 1 === r) && (u && (u._component = null), x = c(u, i, _, n || !P, E && E.parentNode, !0));
                    if (E && x !== E && a !== $) {
                        var R = E.parentNode;
                        R && x !== R && (R.replaceChild(x, E), O || (E._component = null, d(E, !1)))
                    }
                ...
                for (!P || n ? k.push(e) : A || (e.componentDidUpdate && e.componentDidUpdate(b, v, F), w.afterUpdate && w.afterUpdate(e)); e.__h.length;) e.__h.pop().call(e);
                T || o || p()
            }
        }
        ...
        _$lodashThrottle_43 = function (e, r, n) {
            ...
            return y(n) && (o = "leading" in n ? !!n.leading : o, i = "trailing" in n ? !!n.trailing : i),
                function (e, r, n) {
                    ...
                    return r = m(r) || 0, y(n) && (c = !!n.leading, s = (d = "maxWait" in n) ? h(m(n.maxWait) || 0, r) : s, g = "trailing" in n ? !!n.trailing : g), P.cancel = function () {
            ...
            return function (e, t) {
                ...
                return __h_99("div", {
                    ...
                    return __h_99("div", {
                        ...
                        "aria-selected": e.props.activePickerPanel.id === t.id,
                        onclick: function () {
    ...
    var _$FileItem_103 = function (e) {
        ...
        __dummy_107$0 = 0,
        _$PickerPanelContent_107 = function (e) {
            return __h_107("div", {
                class: "uppy-DashboardContent-panel",
                role: "tabpanel",
                "data-uppy-panelType": "PickerPanel",
                id: e.activePickerPanel && "uppy-DashboardContent-panel--" + e.activePickerPanel.id,
                onDragOver: _$ignoreEvent_113,
                onDragLeave: _$ignoreEvent_113,
                onDrop: _$ignoreEvent_113,
                onPaste: _$ignoreEvent_113
    ...
    var _$PickerPanelTopBar_108 = function (e) {
    ...
    function TransitionWrapper(e) {
        return __h_101(_$preactCssTransitionGroup_48, {
            transitionName: "uppy-transition-slideDownUp",
            transitionEnterTimeout: 250,
            transitionLeaveTimeout: 250
        }, e.children)
    }
    var _$Dashboard_101 = function (e) {
        var t = 0 === e.totalFileCount,
            r = _$classnames_9({
        ...
        }, !t && e.showSelectedFiles && __h_101(_$PickerPanelTopBar_108, e), e.showSelectedFiles ? __h_101(t ? _$AddFiles_99 : _$FileList_105, e) : __h_101(_$AddFiles_99, e), __h_101(TransitionWrapper, null, e.showAddFilesPanel ? __h_101(_$AddFilesPanel_100, ___extends_101({
            key: "AddFilesPanel"
        }, e)) : null), __h_101(TransitionWrapper, null, e.fileCardFor ? __h_101(_$FileCard_102, ___extends_101({
            key: "FileCard"
        }, e)) : null), __h_101(TransitionWrapper, null, e.activePickerPanel ? __h_101(_$PickerPanelContent_107, ___extends_101({
        ...
        UploadBtn = function (e) {
            var t = _$classnames_9("uppy-u-reset", "uppy-c-btn", "uppy-StatusBar-actionBtn", "uppy-StatusBar-actionBtn--upload", {
                "uppy-c-btn-primary": e.uploadState === _$StatusBarStates_139.STATE_WAITING
            });
            return __h_138("button", {
                type: "button",
                class: t,
        ...
        ProgressBarProcessing = function (e) {
            ...
            }, __h_138(LoadingSpinner, e), "determinate" === e.mode ? t + "% \xb7 " : "", e.message)
        },
        ...
        defaultPickerIcon = _$icons_109.defaultPickerIcon,
    ...
    var _$lib_110 = function (e) {
        ...
        return function (e, t) {
            ...
            var e = this.getPluginState().activeOverlayType;
            if (e) {
                var t = this.el.querySelector('[data-uppy-panelType="' + e + '"]').querySelectorAll(FOCUSABLE_ELEMENTS);
                return Object.keys(t).map(function (e) {
                    return t[e]
                })
            }
            var r = this.el.querySelectorAll(FOCUSABLE_ELEMENTS);
            ...
            var t = this,
                ...
                g = function (e) {
                    ...
                    return ___extends_110({}, e, {
                        icon: r.icon || t.opts.defaultPickerIcon,
                        render: r.render
                    })
                },
